...
<head>
    ...
    <title> Listing Single || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h3>Listing Single</h3>
                    <div class="thm-breadcrumb__inner">
                        <ul class="thm-breadcrumb list-unstyled">
                            <li><a href="index.html">Home</a></li>
                            <li><span class="icon-arrow-left"></span></li>
                            <li>Listing Single</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="listing-single__top">
                    <div class="listing-single__top-left">
                        <h3 class="listing-single__title">Acura Sport Version</h3>
                                            ...
                                            <div class="col-xl-5 col-lg-5">
                                                <div class="listing-single__left">
                                                    <div class="listing-single__img">
                                                        <img src="assets/images/listing/listing-single-1-1.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="listing-single__right">
                                                    ...
                                                    <div class="listing-single__btn-and-video-box">
                                                        <div class="listing-single__btn-box">
                                                            <a href="cars.html" class="thm-btn">See All Photo<span
                                                                    class="fas fa-arrow-right"></span></a>
                                                        </div>
                                    ...
                                    <div class="listing-single__main-content-inner">
                                        <div class="row">
                                            <div class="col-xl-5 col-lg-5">
                                                <div class="listing-single__left">
                                                    <div class="listing-single__img">
                                                        <img src="assets/images/listing/listing-single-1-2.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-7 col-lg-7">
                                    ...
                                    <div class="listing-single__main-content-inner">
                                        <div class="row">
                                            <div class="col-xl-5 col-lg-5">
                                                <div class="listing-single__left">
                                                    <div class="listing-single__img">
                                                        <img src="assets/images/listing/listing-single-1-3.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-7 col-lg-7">
                                ...
                                <div class="swiper-slide">
                                    <div class="listing-single__img-holder-box">
                                        <div class="listing-single__img-holder">
                                            <img src="assets/images/listing/listing-single-thamb-1-1.jpg" alt="">
                                        </div>
                                    </div>
                                </div><!-- /.swiper-slide -->
                                <div class="swiper-slide">
                                    <div class="listing-single__img-holder-box">
                                        <div class="listing-single__img-holder">
                                            <img src="assets/images/listing/listing-single-thamb-1-2.jpg" alt="">
                                        </div>
                                    </div>
                                </div><!-- /.swiper-slide -->
                                <div class="swiper-slide">
                                    <div class="listing-single__img-holder-box">
                                        <div class="listing-single__img-holder">
                                            <img src="assets/images/listing/listing-single-thamb-1-3.jpg" alt="">
                                        </div>
                                    </div>
                                </div><!-- /.swiper-slide -->
                            </div>
                                                ...
                                                <div class="comment">
                                                    <div class="author-thumb">
                                                        <figure class="thumb"><img
                                                                src="assets/images/shop/review-1-1.jpg" alt="">
                                                        </figure>
                                                    </div>
                                        ...
                                        <div class="review-form-one__inner">
                                            ...
                                            <form action="assets/inc/sendemail.php"
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <button type="submit"
                                                            class="thm-btn review-form-one__btn">Submit a review <span
                                ...
                                <div class="listing-single__seller-info listing-single__single-box">
                                    <div class="listing-single__seller-info-details">
                                        <div class="listing-single__seller-info-img">
                                            <img src="assets/images/listing/listing-single-seller-info-img-1.jpg"
                                                alt="">
                                        </div>
                                    ...
                                    <div class="listing-single__seller-profile">
                                        <a href="#" class="thm-btn">View Profile <span
                                                class="fas fa-arrow-right"></span></a>
                                    </div>
                                </div>
                            </div>
